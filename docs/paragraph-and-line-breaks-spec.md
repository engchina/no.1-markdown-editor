...
- Source editor can optionally reveal tabs, trailing whitespace, and special whitespace characters; line-ending spaces are emphasized so Markdown hard breaks are easier to debug.
